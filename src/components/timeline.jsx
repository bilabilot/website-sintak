      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
           ...
           Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero, aut! Recusandae, magnam quas reprehenderit illum, voluptates tenetur iure dolore
            sapiente perferendis ratione veritatis? Porro minus fugiat ducimus eaque molestiae voluptatibus.
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end md:mb-10">
            ...
            <div className="text-lg font-black">Pengenalan Sintaks Dasar</div>
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono italic">Rabu, 21 2025</time>
